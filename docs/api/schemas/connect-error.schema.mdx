...
sidebar_label: "Connect Error"
hide_title: true
hide_table_of_contents: true
schema: true
sample: {"code":"canceled","message":"string","details":[{"type":"string","value":"string","debug":{}}]}
