...
<Tabs>
  <TabItem label="Canonical Services">
...
| `images.maas.io`                | TCP 80 (HTTP)   |
  ...
  <TabItem label="Snap Package Management">
...
| `canonical-bos01.cdn.snapcraftcontent.com` | TCP 443 (HTTPS) |
  ...
  <TabItem label="Ubuntu Package Repositories">
...
| `esm.ubuntu.com`        | TCP 443 (HTTPS)<br/>TCP 80 (HTTP)\* |
  ...
  <TabItem label="GitHub and OtterScale">

| Domains | Port(s)
| :------------------------------------ | :---------------|
| `otterscale.github.io`                | TCP 443 (HTTPS) |
| `otterscale.com`                      | TCP 443 (HTTPS) |
...
| `release-assets.githubusercontent.com | TCP 443 (HTTPS) |
  ...
  <TabItem label="Kubernetes and image relate">
