...
2.  **Configure Installation**
    ...
    <Aside type="caution" title="Network Configuration">
    	Ensure that the IP addresses are correctly configured for your network environment. Incorrect
    	settings may cause connectivity issues.
    </Aside>
