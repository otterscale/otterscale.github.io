...
Allows you to resize the block device.

<Steps>

1.  Select **Edit** from the actions menu (pencil icon).
2.  Update the **Quota Size** to expand or shrink the device.
...
| **Actions** | Provides options to manage the snapshot (Rollback, Protect, Unprotect, Delete). |
