...
| **Created At** | The creation timestamp of the subvolume.                                                                                                   |
...
| **Created At**     | The creation timestamp of the snapshot.                           |
| **Actions**        | Provides options to manage the snapshot (Delete).                 |
...
| **Created At** | The creation timestamp of the group.     |
